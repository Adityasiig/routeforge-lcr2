        ...
        {vlSummary && (
          <div aria-live="polite" style={{ marginTop: "20px" }}>
            <div className="metrics">
              ...
              <div><span>Markup</span><strong>{vlSummary.markupPercent ? `${vlSummary.markupPercent}%` : "None"}</strong></div>
            ...
            {vlDownloadUrl && (
              <div style={{ marginTop: "18px", clear: "both" }}>
                <a
                  ...
                  style={{ display: "block", width: "100%", gridColumn: "auto", gridRow: "auto", position: "static", boxSizing: "border-box" }}
                >
